...
@cache_data
def create_schedule(to_schedule: list[tuple[str, Timespan]], employees: dict[str, Employee], max_time=10) -> list[tuple[str, str, Timespan]] | None:
    """
    ...
    if max_time > 0: solver.parameters.max_time_in_seconds = max_time
